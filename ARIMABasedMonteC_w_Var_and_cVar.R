...
#Testing on values from 0 to the n value tested (from 0 to yesterday, 
# to understand how today has moved)

st_excl_n=st[0:38]
var_95_excl_n <- quantile(st_excl_n, 0.95)  # 95th percentile (upper tail)
var_99_excl_n <- quantile(st_excl_n, 0.99)  # 99th percentile (upper tail)
cat("\nValue at Risk - 95% worst case (upper 5%):", var_95_excl_n, "\n")
cat("Value at Risk - 99% worst case (upper 1%):", var_99_excl_n, "\n")
es_95_excl_n <- mean(st_excl_n[st_excl_n >= var_95_excl_n])
es_99_excl_n <- mean(st_excl_n[st_excl_n >= var_99_excl_n])
cat("Expected Shortfall - 95% level:", es_95_excl_n, "\n")
cat("Expected Shortfall - 99% level:", es_99_excl_n, "\n")